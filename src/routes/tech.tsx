...
export const Route = createFileRoute("/tech")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: `The technology, system flow, security model, and 8-week build timeline behind ${import.meta.env.VITE_APP_NAME || "LocalVoice"}.`,
      },
      {
        property: "og:title",
        content: `${import.meta.env.VITE_APP_NAME || "LocalVoice"} Architecture — Open, secure, reliable`,
      },
      {

...
export const Route = createFileRoute("/research")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: `Door-to-door interviews and priority rankings from neighborhoods in Tirupati that shaped ${import.meta.env.VITE_APP_NAME || "LocalVoice"}.`,
      },
      {
        property: "og:title",
        content: `${import.meta.env.VITE_APP_NAME || "LocalVoice"} Field Research — Built from the neighborhood up`,
      },
      {
        ...
        <div>
          ...
          <Reveal delay={160}>
            <p className="mt-5 text-lg text-[color:var(--text-secondary)] leading-[1.7] max-w-[520px]">
              ...
              observations shaped every screen of {import.meta.env.VITE_APP_NAME || "LocalVoice"}.
            </p>
          </Reveal>

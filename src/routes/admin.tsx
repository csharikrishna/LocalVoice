...
function AdminRouteWrapper() {
  ...
  if (role === "department_admin" || role === "field_worker") {
    switch(department) {
      case "Electrical": return <ElectricalDashboard />;
      case "Sanitation": return <SanitationDashboard />;
      case "Water Board": return <WaterDashboard />;
      case "Public Works": return <PublicWorksDashboard />;
      case "Parks & Rec": return <ParksDashboard />;
      default: return <div className="p-8 text-red-600">Error: Unknown Department "{department}"</div>;
    }
  }

      ...
      <div className="container-x mb-8">
        ...
        <Reveal delay={160}>
          <p className="mt-4 text-lg text-slate-300 max-w-xl">
            Our high-visibility QR posters are placed precisely where civic issues happen. Reporting
            takes seconds — right from the scene.
          </p>
        </Reveal>
      </div>
        ...
        >
          ...
          {slides.map((slide, i) => (
            <Reveal key={slide.id} delay={i * 100} className="shrink-0 snap-start">
              <div className="hide-scrollbar w-[280px] sm:w-[320px] bg-slate-800 rounded-3xl overflow-hidden border border-slate-700 shadow-xl group cursor-grab active:cursor-grabbing">
